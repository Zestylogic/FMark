...
let lexTokenizeTokenTest =
    let tokenTests = makeTestFromCharListWithB charList ENDLINE [ENDLINE;ENDLINE]
...
let lexTest =
    makeSimpleTestList lex "Lex" [
        "Literal",
        "Hello",
        [ENDLINE;ENDLINE; LITERAL "Hello"; ENDLINE]

        "Number",
        "9",
        [ENDLINE;ENDLINE; NUMBER "9"; ENDLINE]

        "WhiteSpace",
        "d          ",
        [ENDLINE;ENDLINE; LITERAL "d"; WHITESPACE 10; ENDLINE]

        "Very simple markdown",
        "Hello, world",
        [ENDLINE;ENDLINE; LITERAL "Hello"; COMMA; WHITESPACE 1; LITERAL "world"; ENDLINE]

        "With special characters",
        "There is _nothing_ to do",
        [ENDLINE;ENDLINE; LITERAL "There"; WHITESPACE 1; LITERAL "is"; WHITESPACE 1; UNDERSCORE
        ...
        "One line codeblock",
        "``` python",
        [ENDLINE;ENDLINE; CODEBLOCK ("", Python); ENDLINE]

        "One line html",
        "<span>This is a span element</span>",
        [ENDLINE;ENDLINE; LITERAL "<span>"; LITERAL "This is a span element"; LITERAL "</span>"; ENDLINE]

        "Online closing html",
        "<img src=\"https://github.com/IMAGE.png\" />",
        [ENDLINE;ENDLINE; LITERAL "<img src=\"https://github.com/IMAGE.png\" />"; ENDLINE]

        "HTML with non-HTML start",
        "This is an image: <span>Hello</span>",
        [ENDLINE;ENDLINE; LITERAL "This"; WHITESPACE 1; LITERAL "is"; WHITESPACE 1; LITERAL "an"
        ...
        [ENDLINE;ENDLINE; LITERAL "Singleton"; WHITESPACE 1; LITERAL "<br>"; WHITESPACE 1; LITERAL "passthrough"; ENDLINE]

        "HTML image tag",
        "Embedding an <img src=\"https://github.com/IMAGE\"> in text",
        [ENDLINE;ENDLINE; LITERAL "Embedding"; WHITESPACE 1; LITERAL "an"; WHITESPACE 1; LITERAL"<img src=\"https://github.com/IMAGE\">"
         WHITESPACE 1; LITERAL "in"; WHITESPACE 1; LITERAL "text"; ENDLINE]

        "A lot of nested tags",
        "<p><p><p><p><p><p><p> </p></p></p></p></p></p></p>",
        [ENDLINE;ENDLINE; LITERAL "<p>"; LITERAL "<p>"; LITERAL "<p>"; LITERAL "<p>"; LITERAL "<p>"; LITERAL "<p>"
